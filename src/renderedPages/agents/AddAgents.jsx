...
const AddAgent = () => {
  ...
  return agentLoading ? (
    <h1 className="title">Adding Agent....</h1>
  ) : (
      ...
      <form onSubmit={submitHandler} className={classes.form__control}>
        ...
        <div className={classes.inputs}>
          <div className={""}>
            ...
            />
            {!isEmpty(agent.name) && (
              <p className="agent-error">Name field cannot be empty</p>
            )}
          </div>
          <div className={""}>
            ...
            />
            {!isEmail(agent.email) && (
              <p className="agent-error">Please enter a valid email</p>
            )}
          </div>
        </div>
        <div className={""}>
          ...
          />
          {!isNumber(agent.phone) && (
            <p className="agent-error">Enter a valid phone number</p>
          )}
        </div>
        <div className={classes.inputs}>
          <div className={""}>
            ...
            <input
              ...
              onChange={(e) =>
                setAgent({ ...agent, home_address: e.target.value })
              }
              placeholder="Enter Agent Home Address"
            />
            {!isEmpty(agent.home_address) && (
              <p className="agent-error">Address field cannot be empty</p>
            )}
          </div>
          <div className={""}>
            ...
            <input
              ...
              onChange={(e) =>
                setAgent({ ...agent, work_address: e.target.value })
              }
              placeholder="Enter Agent Work Address"
            />
            {!isEmpty(agent.work_address) && (
              <p className="agent-error">Address field cannot be empty</p>
            )}
          </div>
        </div>
